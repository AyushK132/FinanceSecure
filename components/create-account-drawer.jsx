...
function CreateAccountDrawer({ children }) {
    ...
    const onSubmit = async (data) => {
        await createAccountFn(data);  // Call createAccountFn directly with data
    };
                ...
                <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                    <div className="px-4 pb-4">
                        <div className="space-y-2">
                            ...
                            <Input id="name" placeholder="Example: Main Checking" {...register("name")} />
                            {errors.name && (
                    ...
                    <div className="flex items-center justify-between rounded-lg border p-3">
                        <div className="space-y-2">
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-muted-foreground">This Account will be set as default for transactions</p>
                            </div>
                    ...
                    <div className="flex justify-between px-4 pb-4">
                        <DrawerClose asChild>
                            <Button type="button" variant="outline" className="w-auto">Cancel</Button>
                        </DrawerClose>

                        <Button type="submit" className="w-auto" disabled={createAccountLoading}> 
